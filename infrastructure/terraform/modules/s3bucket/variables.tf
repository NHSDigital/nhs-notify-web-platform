...
variable "notification_events" {
  type        = any
  description = "Object representing the notification events for the bucket"
  default     = {}
}

variable "bucket_notification_depends_on" {
  type        = list(any)
  description = "Bucket notification explicit dependencies for depends_on meta"
  default     = []
}
